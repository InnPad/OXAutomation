# ==============================================================================
#
# Note: This installation script has been customized to use local files so that 
# the script may be run on servers without internet access.
#
# ==============================================================================
...
# variables
$url = "file:///c:/vagrant/tools/chocolatey/chocolatey.0.9.8.23.nupkg"
...
Download-File 'file:///c:/vagrant/tools/7-zip/7za.exe' "$7zaExe"
